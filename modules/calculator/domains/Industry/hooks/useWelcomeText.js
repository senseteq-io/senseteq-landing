  ...
  useEffect(() => {
    if (industries) {
      setData({
        ...
        descriptionLine1: t(`calculator.industries.welcome.options.${industries}.descriptionLine1`),
        descriptionLine2: t(`calculator.industries.welcome.options.${industries}.descriptionLine2`),
        buttonText: t(`calculator.industries.welcome.options.${industries}.buttonText`),
      })
    }
  }, [t, industries])

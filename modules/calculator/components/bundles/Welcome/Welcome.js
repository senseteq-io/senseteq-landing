 ...
 */
export default function Welcome({ title, descriptionLine1, descriptionLine2, buttonText, onClick }) {
  return (
    <div className="container">
      <div className="row">
        <div className="col-12 col-lg-6 align-items-center justify-content-center d-flex mb-4">
            <Image src="/assets/welcome.svg" width="380px" height="260px" alt="Build MVP" />
        </div>
        <div className="col-12 col-lg-6">
          <div className="row">
            <div className="col-12 mb-3">
              <Title as="h3" regular>{title}</Title>
            </div>
